...
export default {
  ...
  data() {
    ...
    paragraphs: [
        ...
        '初见您时，便觉得您身上有种难得的气质——年轻，却又沉稳。您没有拘泥于指定的教材，而是带我们走进曼昆那本经典著作的世界；您也不只是讲授书本上的理论，而是常常信手拈来当下的时事政治，让那些原本抽象的经济学概念在现实中有了温度和生命。',
        ...
        '感谢您这一学期的教导。愿您在讲台上，继续保持那份对教育的热忱。也祝您工作顺利，新年快乐！感恩相遇！',
      ]
    }
  },
  mounted() {
